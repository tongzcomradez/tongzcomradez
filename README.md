...
<p align="center">
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&duration=3000&pause=1000&color=FF6B6B&center=true&vCenter=true&width=500&lines=Building+scalable+systems;One+microservice+at+a+time" alt="Typing SVG" /></a>
</p>
...
- 🔭 Backend Engineer focusing on **scalable microservices**
- 🌱 Building **AI Agent Teams** with specialized roles
- 💬 Ask me about **NestJS, MongoDB, RabbitMQ, Microservices**
- 📍 Based in **Bangkok, Thailand 🇹🇭**
- ⚡ Fun fact: I love gaming and building things that scale
...
I believe the future is **multi-agent collaboration**. Meet my 8 specialized AI teams:

| Team | Role | Personality |
|------|------|-------------|
| 🔧 **Engineer** | Code & Architecture | Pragmatic, Detail-oriented |
| 🔍 **Researcher** | Market Intelligence | Curious, Analytical |
| 🎨 **Creative** | Content & Copy | Creative, Persuasive |
| 🚨 **DevOps/SRE** | Infrastructure | Paranoid, Automation-first |
| 🎮 **Game Dev** | Game Systems | Playful, Player-first |
| 🕹️ **Gamer** | Playtesting | Competitive, Honest |
| 🔒 **Cybersecurity** | Security Audits | Proactive, Paranoid |
| 🗄️ **DBA** | Database Optimization | Data-obsessed |
...
**⭐️ From [Joe](https://github.com/tongzcomradez) with ❤️**
