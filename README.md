...
- 🏗️  Designing microservices with **NestJS, MongoDB, Redis, RabbitMQ**
- ☸️  Running workloads on **Kubernetes** with **GitOps** (ArgoCD / Flux)
- 🛠️  Provisioning cloud infra with **Terraform** + **Terragrunt**
